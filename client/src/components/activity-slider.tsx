      ...
      <div className="h-full overflow-x-auto overflow-y-hidden px-6 py-4">
        <div className="flex gap-4 h-full" data-testid="activity-feed">
          {clicks.map((click) => (
            <Card
              key={click.id}
              className="min-w-[240px] px-4 py-3 flex items-center gap-3 shadow-sm hover-elevate"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate font-mono" data-testid={`text-clicker-${click.id}`}>
                  {truncateAddress(click.clickedBy)}
                </p>
